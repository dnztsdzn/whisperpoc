...
language="french" # Language of audio file
...
#  ---------------------------------------------------
# result = model.transcribe(audio=filePath, language=language, word_timestamps=word_timestamps, verbose=verbose)
result = model.transcribe(audio=filePath, word_timestamps=word_timestamps, verbose=verbose, task = 'translate')
